...
INSERT INTO `detallescompra` (`lineaCompra`, `idUsuario`, `idProducto`, `unidades`, `precio`, `importe`) VALUES
	(28, 18, 12, 3, 459.00, 1377.00),
	(29, 18, 4, 22, 489.95, 10778.90),
	(30, 18, 3, 1, 899.00, 899.00),
	(31, 18, 3, 5, 899.00, 4495.00),
	(32, 18, 4, 25, 489.95, 12248.75);
...
-- Volcando datos para la tabla tienda2.usuarios: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
INSERT INTO `usuarios` (`id`, `nombreUsuario`, `contrasenya`, `nombre`, `apellidos`, `direccion`, `codigoPostal`, `correoElectronico`, `dni`) VALUES
	(12, 'angel', 'ad', 'asd', 'asd', 'asd', 00002, 'oko@gmail.com', ''),
	(18, 'la', 'la', 'aijdaspp', 'pasokdpsa', 'poaskdpoa', 02121, 'zozpcoz@gmail.com', '');
