...
-- Volcando datos para la tabla tiendafinal.categorias: ~12 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `linea_pedido` (
  ...
  CONSTRAINT `linea_pedido_ibfk_3` FOREIGN KEY (`id_pedido`) REFERENCES `pedido` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla tiendafinal.linea_pedido: ~1 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `pedido` (
  ...
  KEY `id_3` (`id`),
  KEY `id_4` (`id`),
  CONSTRAINT `pedido_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
...
-- Volcando datos para la tabla tiendafinal.usuarios: ~3 rows (aproximadamente)
