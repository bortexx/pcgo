...
CREATE DATABASE IF NOT EXISTS `tiendafinal` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci */;
USE `tiendafinal`;

-- Volcando estructura para tabla tiendafinal.carrusel
...
-- Volcando datos para la tabla tiendafinal.carrusel: ~3 rows (aproximadamente)
...
-- Volcando estructura para tabla tiendafinal.categorias
...
-- Volcando datos para la tabla tiendafinal.categorias: ~9 rows (aproximadamente)
...
-- Volcando estructura para tabla tiendafinal.linea_pedido
CREATE TABLE IF NOT EXISTS `linea_pedido` (
  ...
  CONSTRAINT `linea_pedido_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id`),
  CONSTRAINT `linea_pedido_ibfk_3` FOREIGN KEY (`id_pedido`) REFERENCES `pedido` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla tiendafinal.linea_pedido: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla tiendafinal.pedido: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `pedido` DISABLE KEYS */;
/*!40000 ALTER TABLE `pedido` ENABLE KEYS */;

-- Volcando estructura para tabla tiendafinal.productos
...
-- Volcando datos para la tabla tiendafinal.productos: ~24 rows (aproximadamente)
...
-- Volcando estructura para tabla tiendafinal.usuarios
...
-- Volcando datos para la tabla tiendafinal.usuarios: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `usuarios` DISABLE KEYS */;
INSERT INTO `usuarios` (`id`, `nombreUsuario`, `contrasenya`, `nombre`, `apellidos`, `direccion`, `codigoPostal`, `correoElectronico`, `admin`) VALUES
	(0, 'admin', 'admin', 'admin', 'adminadmin', 'c/ admin', 00000, 'admin@gmail.com', 1),
	(12, 'angel', 'ad', 'asd', 'asd', 'asd', 00002, 'oko@gmail.com', 0),
	(13, 'ayami', 'ayami', 'asdas', 'adsad', 'asddsa', 00022, 'aaa@aaa.com', 0),
	(14, 'carl', 'carl', 'carlos', 'carlos', 'carlos', 00001, 'carlos@gmail.com', 0),
	(15, 'Ka', 'Ka', 'w', 'w', 'dasdasda', 55922, 'alguno@gmail.com', 0);
